...
describe('12 - Testa se', () => {
  ...
  it('12.2 - Se o botão Done Recipes da tela de Perfil funciona conforme protótipo',
    async () => {
  ...
  it('12.3 - Se o botão Favorite Recipes da tela de Perfil funciona conforme protótipo',
    async () => {
      history.push('/profile/');
  ...
  it('12.4 - Se o botão Logout da tela de Perfil funciona conforme protótipo',
    async () => {
      history.push('/profile/');
